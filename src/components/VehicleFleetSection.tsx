...
export default function VehicleFleetSection({ items }: VehicleFleetSectionProps = {}) {
  ...
  const notes = [
    ...
    "Force Traveller Daily Rates: 12-Seater (₹7,500/day), 16-Seater (₹8,500/day), 25-Seater (₹9,500/day).",
    "Force Urbania Daily Rates: 10-Seater (₹8,500/day), 13-Seater (₹9,000/day), 17-Seater (₹9,500/day).",
